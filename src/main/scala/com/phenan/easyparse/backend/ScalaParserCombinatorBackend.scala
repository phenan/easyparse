...
trait ScalaParserCombinatorBackend {
  ...
  private lazy val parsers = new ScalaParsersBackedParser(lexer, whitespace)
}

private trait EvaluatorTokens extends Tokens {
...
private class ScalaParsersBackedParser [E] (lexer: Lexer[E], whitespaceLexer: Lexer[Any]) extends Parsers {
